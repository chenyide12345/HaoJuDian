...
@interface CYDBaseNavigationController () <UINavigationControllerDelegate, UIGestureRecognizerDelegate>

@property (nonatomic, strong) UIPanGestureRecognizer *popPanGesture;

@end

@implementation CYDBaseNavigationController

static CYDBaseNavigationController *baseNavigationController;
...
+ (instancetype)shareNavgationController {
    ...
    if (!baseNavigationController) {
        ...
        dispatch_once(&onceToken, ^{
            baseNavigationController = [[CYDBaseNavigationController alloc] init];
        });
    }
...
- (instancetype)initWithRootViewController:(UIViewController *)rootViewController {
    CYDBaseNavigationController *baseNavigationController = [CYDBaseNavigationController shareNavgationController];
